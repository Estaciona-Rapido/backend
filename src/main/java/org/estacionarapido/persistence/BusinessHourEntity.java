...
@NamedQuery(name = "BusinessHours.getById",
    query = "SELECT new org.estacionarapido.dto.BusinessHour(entity.id, entity.isActivated, entity.startWeekDay, entity.endWeekDay, entity.startTime, entity.endTime) FROM BusinessHourEntity entity WHERE entity.scenario.id = :id")
